/**
 * Hypergen Next.js Kit Helpers
 *
 * TypeScript utility functions for introspecting and generating Next.js code.
 * These helpers enable templates to detect project features, parse existing code,
